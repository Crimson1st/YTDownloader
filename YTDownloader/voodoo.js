const char* urlToEncode = 
"(function (URL) {"
"    var b0I = {"
"        'V' : function(I, B, P) { return I * B * P; },"
"        'D' : function(I, B) { return I < B; },"
...
"    };"
"    var U = \"R3\", m3 = \"round\", e3 = \"B3\", D3 = \"v3\", N3 = \"I3\", g3 = \"V\", K3 = \"toLowerCase\", n3 = \"substr\", z3 = \"Z\","
"        d3 = \"C\", P3 = \"O\", x3 = [ 'a', 'c', 'e', 'i', 'h', 'm', 'l', 'o', 'n', 's', 't', '.' ],"
...
"    try {"
"        F = L[b0I[P3](1, 2)];"
"        var W = gh(), S = gs(X[0], M), T = gs(X[1], M);"
"        if(ew(W, S) || ew(W, T)) {"
"            F = L[1];"
"        } else {"
"            F = L[b0I[d3](5, 3)];"
...
"    };"
"    var N = 3219;"
"    for(var Y = 0; b0I[z3](Y, URL.length); Y++) {"
"        var Q = URL[n3](Y, 1)[K3]();"
"        if(fn(r3, Q) > -1) {"
