...
#ifndef _YTDOWNLOADER_YTDOWNLOADER_WXCRAFTER_BASE_CLASSES_H
#define _YTDOWNLOADER_YTDOWNLOADER_WXCRAFTER_BASE_CLASSES_H
...
protected:
    virtual void OnGetURLs(wxCommandEvent& event) { event.Skip(); }
    virtual void OnExit(wxCommandEvent& event) { event.Skip(); }
    virtual void OnAbout(wxCommandEvent& event) { event.Skip(); }

public:
    wxButton* GetButton13() { return m_button13; }
    wxMediaCtrl* GetMediaCtrl15() { return m_mediaCtrl15; }
